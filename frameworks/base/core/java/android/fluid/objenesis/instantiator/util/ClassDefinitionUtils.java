...
//   private static Method DEFINE_CLASS;
   ...
   // * @param className class name in the format <code>android.fluid.objenesis.MyClass</code>
   ...
   /**
    * Will convert a class name to its name in the class definition format (e.g {@code android.fluid.objenesis.EmptyClass}
   ...
   /**
    * Will convert a class name to its class loader resource name (e.g {@code android.fluid.objenesis.EmptyClass}
